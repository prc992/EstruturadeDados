...
func (ListaEncadeada *TADListaEncadeada) AdicionaFim(ValorNo int) {
	...
	if ListaEncadeada.caudaNo == nil {
		...
		//Lista Circular conecto o proximo do nó cabeça a cauda
		ListaEncadeada.cabecaNo.proximoNo = ListaEncadeada.caudaNo
...
func (ListaEncadeada *TADListaEncadeada) AdicionaInicio(ValorNo int) {
	...
	if ListaEncadeada.listaVazia == 1 {
		//fmt.Println("Inserir inicio, lista vazia - ", ValorNo)
		mNo.ValorNo = ValorNo
		mNo.proximoNo = nil
		ListaEncadeada.cabecaNo = mNo
		ListaEncadeada.caudaNo = mNo
	} else {
		//fmt.Println("Inserir inicio, lista não vazia - ", ValorNo, "Cauda no:", ListaEncadeada.caudaNo)
		mNo.ValorNo = ValorNo
		mNo.proximoNo = ListaEncadeada.caudaNo
		ListaEncadeada.caudaNo = mNo
